...
> ⚠️ **NOTA**: Este documento foi criado quando o sistema usava Firebase. O sistema agora usa MongoDB + JWT próprio. Consulte [DEPLOY_COMPLETO.md](../DEPLOY_COMPLETO.md) para arquitetura atual.
